...
@WebServlet("/ajoutCategorieMinistere")
public class ServletAjoutCategorie extends HttpServlet {
...
//			request.setAttribute("categories", categories);
			request.getRequestDispatcher("Dashboard_ministere/ajoutCategorie.jsp").forward(request, response);
