...
@WebServlet("/ajout_unite_de_mesure")
public class ServletAjoutUniteDeMesure extends HttpServlet {
	...
	public ServletAjoutUniteDeMesure() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			...
			request.getRequestDispatcher("Dashboard_ministere/ajoutUniteDeMesure.jsp").forward(request, response);
