...
public class Besoin implements Serializable 
{
	...
	private Collection<PhotoBesoin> photoBesoins;
	...
	public Collection<PhotoBesoin> getPhotoBesoins() {
		return photoBesoins;
	}



	public void setPhotoBesoins(Collection<PhotoBesoin> photoBesoins) {
		this.photoBesoins = photoBesoins;
	}
